...
- `src/main/res/font/dejavu_serif.ttf`, `dejavu_serif_bold.ttf`: DejaVu Serif
  (Book, Bold), DejaVu fonts project, https://dejavu-fonts.github.io/ —
  Bitstream Vera licence with public-domain changes; embedding and
  redistribution permitted (https://dejavu-fonts.github.io/License.html).
- `src/main/res/font/allura_regular.ttf`: Allura, Copyright 2010 The Allura
